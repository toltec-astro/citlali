...
[ADR 0023](adr/0023-ast-route-family-motion-membership.md). The v1 numerical
...
- Network-specific timing and explicit placement of a requested common
  analysis grid remain governed by ADR 0018.
