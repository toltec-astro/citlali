# ADR 0023: AST route-family motion membership

> Canonical numbering note: this decision first appeared as divergent ADR
> 0020 at `doc/adr/0020-ast-route-family-motion-membership.md`, introduced by
> `672f907355a3f15f3ee987d92a5f7e95bbdc38b5`. It entered canonical application
> ancestry as ADR 0023.
...
ADR 0021 closed the scan-motion estimator only for the exact real TolTEC
...
This ADR partially supersedes ADR 0021 only for its exact supported input
family, producer-state interpretation, and physical-scan membership. ADR 0021
...
- [V1 durable numerical decision](0021-ast-scan-motion-velocity-and-validity.md)
