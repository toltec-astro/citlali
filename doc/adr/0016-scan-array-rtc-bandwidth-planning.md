...
Status: partially superseded by ADR 0017 and ADR 0019; AST authority closed by
ADR 0018; bounded AST implementation passes local, representative-data, and
...
occurrences meeting the threshold. ADR 0019 supersedes use of that maximum as a
...
operator constraints. ADR 0019 suspends the largest-factor and scan-wide
...
- ADR 0019 retains the raw AST maximum but moves upper-speed consequences to
