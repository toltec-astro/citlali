...
| [0006](0006-fruit-loop-restart-checkpoint.md) | Accepted; Choice-A checkpoint v3 validated; D19 closed | Resume fruit loops from a required state-complete iteration checkpoint with absolute iteration identity and fail-closed compatibility checks |
