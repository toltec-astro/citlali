...
| [0014](0014-spack-build-foundation.md) | Accepted; operationally demonstrated by Spack-backed V2 | Use Spack as the current dependency/environment authority while preserving the full refactored application and bounded fallback compatibility build |
...
| [0017](0017-wp7-timestream-successor.md) | Accepted; G0--G3 owner-accepted; G4 bounded replay active | Implement the scientifically closed WP-7.1 timestream contract by bounded replay on canonical application ancestry |
