...
| [0006](0006-fruit-loop-restart-checkpoint.md) | Accepted contract; current v2 implementation fails one enabled path | Resume fruit loops from a required state-complete iteration checkpoint with absolute iteration identity and fail-closed compatibility checks |
