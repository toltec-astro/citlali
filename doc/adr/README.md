...
| [0016](0016-scan-array-rtc-bandwidth-planning.md) | Accepted structure; numerical-policy portion partially superseded by 0017 | Admit science motion at `v >= 1 arcsec/s` and derive RTC bandwidth and factor per scan and array from the authoritative beam and product tolerances |
| [0017](0017-precertified-rtc-filter-bank-and-science-error-budgets.md) | Accepted owner-directed correction; artifacts and implementation pending | Bound added mapped astronomical distortion and retained broadband alias variance at 1%, and select immutable pre-certified filters at runtime |
| [0018](0018-ast-scan-motion-velocity-and-validity.md) | Accepted bounded authority; local and representative-data gates passed; fresh exact-SHA review pending | Define the exact J2000 scan-motion fields, physical-scan membership, continuity, telemetry-defect, derivative, validity, maximum, and network-mapping semantics for WP-7 planning |
