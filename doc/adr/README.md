...
| [0006](0006-fruit-loop-restart-checkpoint.md) | Accepted contract; Choice-A v3 repair implemented locally, real replay pending | Resume fruit loops from a required state-complete iteration checkpoint with absolute iteration identity and fail-closed compatibility checks |
