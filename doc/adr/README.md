...
| [0016](0016-scan-array-rtc-bandwidth-planning.md) | Partially superseded by 0017 and 0019 | Admit science motion at `v >= 1 arcsec/s` and derive RTC bandwidth and factor per scan and array from the authoritative beam and product tolerances |
| [0017](0017-precertified-rtc-filter-bank-and-science-error-budgets.md) | Accepted budgets; scan-maximum lookup superseded by 0019 | Bound added mapped astronomical distortion and retained broadband alias variance at 1%, and select immutable pre-certified filters at runtime |
| [0018](0018-ast-scan-motion-velocity-and-validity.md) | Accepted numerical authority; supported-family and membership clauses partially superseded by 0020 | Define the exact J2000 scan-motion fields, Science/Lissajous membership, continuity, telemetry-defect, derivative, validity, maximum, and network-mapping semantics for WP-7 planning |
| [0019](0019-occurrence-level-rtc-upper-speed-admission.md) | Accepted owner-directed correction; evidence and implementation pending | Retain the truthful AST maximum while admitting upper scan speed per network occurrence and array/mode physical ceiling; defer automatic factor selection to measured retained-support evidence |
| [0020](0020-ast-route-family-motion-membership.md) | Accepted bounded authority; implementation and exact-SHA review pending | Preserve the v1 numerical operator while admitting exact Science/OOF/Pointing Lissajous and rectilinear Beammap physical-membership profiles |
