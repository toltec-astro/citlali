...
| [0018](0018-ast-scan-motion-velocity-and-validity.md) | Accepted bounded authority; implementation and conformance pending | Define the exact J2000 scan-motion fields, physical-scan membership, continuity, telemetry-defect, derivative, validity, maximum, and network-mapping semantics for WP-7 planning |
