...
| --- | --- | --- | --- | --- |
| `APP-CANON-001` | Canonical application integration on `codex/refactor-mainline` at administrative tip `4dc7844e59e03cf2d18a9262fe5b75d3ff078681`, containing accepted offline D2 evidence-tooling integration `f8ba732bc4072e918c2521a013305be354ed7b53` | Normal accepted application work lands only through reviewed canonical ancestry | Active authority; `WP7-REPLAY-002A` candidate `d7d19bc90...` is not integrated | Ordinary affected-behavior gates and owner-controlled integration |
...
| `WP7-REPLAY-002A` | Bounded canonical network-native paired D1 producer contract on `codex/wp7-g4-replay-002a`; exact parent `4dc7844e59e03cf2d18a9262fe5b75d3ff078681`, exact implementation candidate `d7d19bc90d7c994fa767ec2a9fd35e4d8599f032` | Occupies the single WP-7 application WIP slot; no producer adapter, route wiring, common grid, RTC/PTC, D2 observer, filtering, factor selection, downsampling, or production activation | **Candidate implemented and validated; stopped pending owner review; not integrated** | Owner accepts, rejects, or requests bounded repair of the exact candidate |
...
`WP7-REPLAY-002A` occupies it in a stopped, owner-review-pending state. A next
increment requires disposition of exact candidate `d7d19bc90...` and a new
bounded owner authorization before source capture, branch creation,
