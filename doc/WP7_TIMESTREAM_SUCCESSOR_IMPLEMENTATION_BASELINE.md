...
> Reconciliation note: this is the preserved divergent implementation baseline
> at `49fe73e757daa1885cd23127e8441cba47e648d2`. It is historical input to the
> canonical program, not the live sequencing authority. See
> [`WP7_TIMESTREAM_SUCCESSOR_PROGRAM.md`](WP7_TIMESTREAM_SUCCESSOR_PROGRAM.md).

Status: historical accepted design and implementation-prompt basis; superseded
as live sequencing authority by `WP7_TIMESTREAM_SUCCESSOR_PROGRAM.md`
...
At the preserved divergent snapshot, this document was the living
implementation baseline for the WP-7 successor. It records how that lane
intended to construct and migrate the new timestream execution spine. It does
not restate, extend, or reopen the scientific contract, and it does not
authorize canonical replay by itself.
...
2. [ADR 0017](adr/0017-wp7-timestream-successor.md), which selects bounded
   subsystem succession and its migration boundary;
3. this preserved historical implementation baseline, for design intent only;
...
- [ADR 0017](adr/0017-wp7-timestream-successor.md)
