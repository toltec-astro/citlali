...
`tools/wp7/analyze_rtc_scan_array_policy_candidate.py` and its checked result
`validation/wp7_rtc_scan_array_policy_candidate_2026-08-29.json`, both at
preserved divergent snapshot
