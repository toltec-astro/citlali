# SCI-FLT-MATCHED_TO_SCI-NOI v0.1/r0.3

Status: exact compatibility-boundary repair draft; no NOI realization,
...
noise, or instantiates U1. Empirical covariance evidence separately binds its
sampling model, draw dependence or ergodic premise, finite moments, estimator,
normalization, convergence criterion/mode, uncertainty construction, and
coverage.
