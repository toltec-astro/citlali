#!/usr/bin/env python3
"""Build deterministic SCI-NOI Stage B r0.3 PDFs from byte-bound sources."""
...
OWNER_SUPPLEMENT = HERE / "SCIENTIFIC_OWNER_DECISION_SUPPLEMENT.md"
...
MODULE_BINDING_SHA256 = "b7756dbeeace639e4ec86878466fb2afcc20fe5b8d256b48b6747bff1527e03c"
...
SOURCE_TO_PDF = {
    "SCIENTIFIC_RATIONALE.md": "SCI-NOI_v0.1_STAGE_B_SCIENTIFIC_RATIONALE_DRAFT_r0.3.pdf",
    "NORMATIVE_CORE.md": "SCI-NOI_v0.1_STAGE_B_NORMATIVE_CORE_DRAFT_r0.3.pdf",
    "ENGINEERING_CONFORMANCE_SPECIFICATION.md":
        "SCI-NOI_v0.1_STAGE_B_ENGINEERING_CONFORMANCE_DRAFT_r0.3.pdf",
}
...
class OwnerRenderer(BASE.MarkdownPdfRenderer):
    ...
    def _cover(self) -> None:
        ...
        self.ax.text(1.22, 0.72, "r0.18 packet b6f8e725...77ca0 | r0.3 owner 4b622de9...77e5",
...
def build(output_dir: Path, write_manifest: bool) -> dict:
    ...
    result = {
        "manifest_identity": "SCI-NOI_STAGE_B_SOURCE_AND_BUILD_MANIFEST v0.1/draft-r0.3",
        ...
        "r0_3_normative_binding_sha256": MODULE_BINDING_SHA256,
