#!/usr/bin/env python3
"""Build deterministic SCI-NOI Stage B r0.5 PDFs from byte-bound sources."""
...
R04_OWNER_DIRECTIVE = STAGE_B / "r0.4/SCIENTIFIC_OWNER_DIRECTIVE.md"
R04_OWNER_DIRECTIVE_SHA256 = "f155c1e70c1a8431bf4baf68f111960456ef24e9e77544837ff2efbecb86f423"
OWNER_DIRECTIVE = HERE / "SCIENTIFIC_OWNER_DIRECTIVE.md"
OWNER_DIRECTIVE_SHA256 = "4f04e25a32b44b729bd291d4919c9acb4bc197f79d94f7f213f4d9505539114d"
MODULE_BINDING = HERE / "NORMATIVE_MODULE_BINDING.json"
MODULE_BINDING_SHA256 = "aa59ecaaaa149e2990d07623563d90af76c7b3084ee37c497a06e17ebf0fe213"
PROPOSED_PROFILES = HERE / "PROPOSED_PROFILE_SUCCESSORS.md"
PROPOSED_PROFILES_SHA256 = "aa1c53e7400f8b38804bc0002f23731b6d4b2d04a87b663a67151e4c07065f75"
...
SOURCE_TO_PDF = {
    "SCIENTIFIC_RATIONALE.md": "SCI-NOI_v0.1_STAGE_B_SCIENTIFIC_RATIONALE_DRAFT_r0.5.pdf",
    "NORMATIVE_CORE.md": "SCI-NOI_v0.1_STAGE_B_NORMATIVE_CORE_DRAFT_r0.5.pdf",
    "ENGINEERING_CONFORMANCE_SPECIFICATION.md":
        "SCI-NOI_v0.1_STAGE_B_ENGINEERING_CONFORMANCE_DRAFT_r0.5.pdf",
}
...
def verify_bindings() -> tuple[dict[str, str], dict[str, str]]:
    ...
    if sha256(R04_OWNER_DIRECTIVE) != R04_OWNER_DIRECTIVE_SHA256:
        raise RuntimeError("r0.4 owner directive hash mismatch")
...
class OwnerRenderer(BASE.MarkdownPdfRenderer):
    ...
    def _cover(self) -> None:
        ...
        warning = ("Conditional owner-freeze candidate; not frozen. No implementation "
                   "conformity, generator validation, calibration, "
        ...
        self.ax.text(1.22, 0.72, "r0.18 packet b6f8e725...77ca0 | r0.5 owner 4f04e25a...114d",
...
def build(output_dir: Path, write_manifest: bool) -> dict:
    ...
    result = {
        "manifest_identity": "SCI-NOI_STAGE_B_SOURCE_AND_BUILD_MANIFEST v0.1/draft-r0.5",
        ...
        "r0_4_owner_directive_sha256": R04_OWNER_DIRECTIVE_SHA256,
        ...
        "r0_5_normative_binding_sha256": MODULE_BINDING_SHA256,
