...
Manifest identity: `SCI-NOI_AUTHOR_PACKET_MANIFEST v0.1/r0.4`
...
| --- | --- | --- | --- |
| 1 | `SCOPE_BRIEF.md` | `c6698e2622ee2a3bae377139331e4ba3225a225e200b2d16dd82d23f32f4ce4a` | ODQ-101/102A/102B incorporated; selected route/design numerically unavailable |
...
| 6 | `AUTHOR_OPERATOR_AND_PRODUCT_TAXONOMY.md` | `9412a31a034c29098b610cb91db5822e28056a523e90f0bc92944e7f3f383a76` | Proposed collision-free taxonomy; ordinary route/coherence selected |
...
| 9 | `SCI-PTC_TO_SCI-NOI-GEN_BOUNDARY.md`, `SCI-PTC_TO_SCI-NOI-GEN v0.1/r0.3` | `1ddc38d7d9bb6872154bfbea3d7792f27e460f5a5c3e8bbb074149b094b28074` | Exact frozen-source extract; MAP route/coherence selected but numerically unavailable; JINC host unselected |
| 10 | `NOI_GEN_PARENT_OPERATOR_GRAPH.md`, `SCI-NOI_GEN_PARENT_OPERATOR_GRAPH v0.1/r0.3` | `4cf5661ebe8cb1a8269e20cd4a76473d7203c65aab21b630c76e3a2aecca302a` | ODQ-101/102A/102B approved; selected route/design conditional/unavailable |
| 11 | `ENSEMBLE_DESIGN_AND_SOURCE_IMPRINT_SPECIFICATION.md`, `SCI-NOI_ENSEMBLE_DESIGN_AND_SOURCE_IMPRINT v0.1/r0.2` | `7f9c3702dbe1dc2613e7fa9e88f57fd249a687e87fe1639408d6096294217a81` | Ordinary coherence approved; ODQ-102C and 103 open |
...
| 14 | `SCI-NOI_VAL_PROFILE_DRAFTS.md` | `345fbefaaea5fcb9b0abb9df5d3e396b07cd6c99f590f6b45ae94d198238cd70` | NOI-owned drafts; selected route/coherence action proposed; unapproved/unregistered/unevaluable |
...
| 17 | `SCIENTIFIC_OWNER_DECISIONS_FOR_AUTHORSHIP.md`, `SCI-NOI_OWNER_DECISIONS v0.1/r0.4` | `8675347837ec2187124687ed2c78d30efb46c5728eae1b1d1d70396e5c26a334` | ODQ-101/102A/102B/104 decided; ODQ-102C recommendation exact; later methods unavailable while open |
...
the Scope Brief. The next walkthrough item is `SCI-NOI-ODQ-102C`.
