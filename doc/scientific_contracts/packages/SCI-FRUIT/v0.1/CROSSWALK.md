...
| Comparative definition of better | `SCIENTIFIC_OWNER_COMPARATIVE_QUALITY_DIRECTION_2026-08-31.md`; `COMPARATIVE_QUALITY_OBJECTIVE_GATE.md`; `RESPONSE_UNCERTAINTY_CONVERGENCE_CLAIM_MATRIX.md` | Direct owner direction plus sanitized Stage A metric analysis | Exact historical control required; scientific and computational vectors separated; exact metrics, thresholds, and tradeoffs open |
...
| Ordered owner decisions and walkthrough | `SCIENTIFIC_OWNER_DECISION_LEDGER.md`; `SCIENTIFIC_OWNER_RECURRENCE_REVIEW_DIRECTION_2026-08-31.md`; `SCIENTIFIC_OWNER_PROVISIONAL_CHOICE_3_DIRECTION_2026-08-31.md`; `SCIENTIFIC_OWNER_COMPARATIVE_QUALITY_DIRECTION_2026-08-31.md` | Genuine new-work synthesis plus direct owner Stage A directions | Revised ODQ-001 first; provisional Choice 3 and comparative domains recorded; all ODQs remain open |
