# SCI-FRUIT — iteration, operation state and lifecycle r0.4

Status: owner-directed Stage A candidate. Authority: repair direction
SCI-FRUIT-OD-STAGE-A-MICRO-REPAIR-2026-09-07, sections 1, 3, 6–7;
...
this convention chooses no update law. After completed N, exact continuation
starts from S_(N+1) and next absolute zero-based index N+1.
...
m_k^applied separately, including any acceptance-to-application transformation.
