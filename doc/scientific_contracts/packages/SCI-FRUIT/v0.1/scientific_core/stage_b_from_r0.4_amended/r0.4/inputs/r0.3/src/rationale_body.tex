...
The sole current review-candidate normative core is SCI-FRUIT-NORMATIVE-CORE v0.1/r0.3, bound by
...
The r0.2 architecture is the accepted revision basis and exact historical
comparison evidence. The r0.3 directive requests one narrow successor:
distinguish operator-defining state from internal fixed-map coordinates,
derive the admitted PTC specialization, correct candidate/declaration language
and close delivery links. The r0.3 core supersedes r0.2 as the current review
candidate, without hidden inherited obligations, owner approval, freeze,
Registry registration or activation. Role names are core declarations only.
