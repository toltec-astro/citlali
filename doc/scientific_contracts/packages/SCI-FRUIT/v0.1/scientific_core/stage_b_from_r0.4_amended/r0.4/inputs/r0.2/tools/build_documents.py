"""Build only SCI-FRUIT r0.2 documents from local TeX resources; no science runs."""
from pathlib import Path
import argparse, hashlib, importlib.metadata, json, os, shutil, subprocess, sys
ROOT=Path(__file__).resolve().parents[1]
VIEWS=('core','rationale','ecs')
CORE_ID='SCI-FRUIT-NORMATIVE-CORE v0.1/r0.2'
EPOCH='1788739200'
...
def bind_sources():
    ...
    controls={
      'StageAHash':ROOT/'inputs/scientific_core/r0.4-amended/SCI-FRUIT-v0.1-stage-a-r0.4-amended-owner-review.tar.gz',
      'DirectiveHash':ROOT/'inputs/OWNER_DIRECTIVE_R0.2.txt',
      'ApprovalHash':ROOT/'inputs/scientific_core/SCI_FRUIT_STAGE_A_R0.4_AMENDED_OWNER_APPROVAL_2026-09-07.md',
      'InterimHash':ROOT/'inputs/OWNER_INTERIM_CORRECTION_R0.2.txt',
      'FreezeHash':ROOT/'inputs/scientific_core/SCI_FRUIT_STAGE_A_R0.4_AMENDED_OWNER_FREEZE_2026-09-07.md',
