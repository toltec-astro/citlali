"""Build only SCI-FRUIT r0.3 documents from local TeX resources; no science runs."""
from pathlib import Path
import argparse, hashlib, importlib.metadata, json, os, shutil, subprocess, sys
ROOT=Path(__file__).resolve().parents[1]
VIEWS=('core','rationale','ecs')
CORE_ID='SCI-FRUIT-NORMATIVE-CORE v0.1/r0.3'
EPOCH='1788825600'
...
def bind_sources():
    ...
    controls={
      ...
      'DirectiveHash':ROOT/'inputs/OWNER_DIRECTIVE_R0.3.txt',
