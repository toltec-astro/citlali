# Document build recipe - SCI-FRUIT v0.1/r0.3

Build-record identity: SCI-FRUIT-DOC-BUILD-R0.3-2026-09-08. Scope: local document compilation, rendering and identity checks only.

From the extracted `r0.3` directory, with the declared local runtime and resource prerequisites:
...
```sh
/Users/gwilson/tolteca/bin/python tools/verify_documents.py
/Users/gwilson/tolteca/bin/python tools/package_documents.py --verify-only --archive /absolute/path/to/SCI-FRUIT-v0.1-stage-b-r0.3-owner-review.tar.gz
```
