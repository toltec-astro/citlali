...
Status: Stage B bounded freeze-candidate draft `r0.3`; generated from the shared normative macro metadata

Coverage: 89 requirements and 49 predictions.
...
| `SCI-PTC-REQ-009` | `src/common/requirements.tex` (One-way state lifecycle) | Rationale ; compact crosswalk | Engineering normative requirements | D004,D009 | None |
...
| `SCI-PTC-REQ-011` | `src/common/requirements.tex` (Cause is not action) | Rationale 2.1; compact crosswalk | Engineering normative requirements | D007 | VAL |
| `SCI-PTC-REQ-012` | `src/common/requirements.tex` (Per-use support map) | Rationale 2.1; compact crosswalk | Engineering normative requirements | D007 | VAL |
| `SCI-PTC-REQ-013` | `src/common/requirements.tex` (Finite eligible arithmetic) | Rationale 2.1; compact crosswalk | Engineering normative requirements | D007 | VAL |
...
| `SCI-PTC-REQ-015` | `src/common/requirements.tex` (Fit-excluded apply-allowed state) | Rationale 2.1; compact crosswalk | Engineering normative requirements | D007 | VAL |
...
| `SCI-PTC-REQ-026` | `src/common/requirements.tex` (Estimator-family identity) | Rationale ; compact crosswalk | Engineering normative requirements | D010 | None |
| `SCI-PTC-REQ-027` | `src/common/requirements.tex` (Robust common-mode family) | Rationale ; compact crosswalk | Engineering normative requirements | D010 | None |
...
| `SCI-PTC-REQ-029` | `src/common/requirements.tex` (Masked/weighted PCA family) | Rationale ; compact crosswalk | Engineering normative requirements | D007,D010,Q002 | None |
...
| `SCI-PTC-REQ-035` | `src/common/requirements.tex` (Conjunctive admission) | Rationale ; compact crosswalk | Engineering normative requirements | D012 | Owner policy |
...
| `SCI-PTC-REQ-054` | `src/common/requirements.tex` (Analysis/gridding coefficient) | Rationale ; compact crosswalk | Engineering normative requirements | D015 | SCI-MAP |
...
| `SCI-PTC-REQ-058` | `src/common/requirements.tex` (Conditional covariance) | Rationale ; compact crosswalk | Engineering normative requirements | D014 | NOI |
...
| `SCI-PTC-REQ-063` | `src/common/requirements.tex` (Full-procedure response) | Rationale ; compact crosswalk | Engineering normative requirements | D013 | None |
...
| `SCI-PTC-REQ-066` | `src/common/requirements.tex` (Response status) | Rationale ; compact crosswalk | Engineering normative requirements | D013,D016 | None |
| `SCI-PTC-REQ-067` | `src/common/requirements.tex` (Map-center diagnostic) | Rationale ; compact crosswalk | Engineering normative requirements | D016 | SCI-MAP,BEAM |
...
| `SCI-PTC-REQ-071` | `src/common/requirements.tex` (Material provenance) | Rationale ; compact crosswalk | Engineering normative requirements | D005 | None |
...
| `SCI-PTC-REQ-076` | `src/common/requirements.tex` (Disabled PTC route) | Rationale ; compact crosswalk | Engineering normative requirements | D005 | SCI-MAP |
...
| `SCI-PTC-REQ-081` | `src/common/requirements.tex` (External source/residual parent) | Rationale ; compact crosswalk | Engineering normative requirements | D004,D014 | AST,FRUIT |
| `SCI-PTC-REQ-082` | `src/common/requirements.tex` (Shifted/null surrogate) | Rationale ; compact crosswalk | Engineering normative requirements | D006,D007 | VAL,NOI |
| `SCI-PTC-REQ-083` | `src/common/requirements.tex` (Exact frozen application map) | Rationale ; compact crosswalk | Engineering normative requirements | D010,Q002 | None |
| `SCI-PTC-REQ-084` | `src/common/requirements.tex` (Candidate evidence retention) | Rationale ; compact crosswalk | Engineering normative requirements | D012 | Owner policy |
| `SCI-PTC-REQ-085` | `src/common/requirements.tex` (Typed astronomical-transfer predicate) | Rationale ; compact crosswalk | Engineering normative requirements | D012,D013 | Owner policy |
| `SCI-PTC-REQ-086` | `src/common/requirements.tex` (Expectation and bias statement) | Rationale ; compact crosswalk | Engineering normative requirements | D010,D014 | NOI |
...
| `SCI-PTC-REQ-088` | `src/common/requirements.tex` (Independent state axes) | Rationale ; compact crosswalk | Engineering normative requirements | D005,D013 | None |
...
| `SCI-PTC-PRED-001` | `src/common/edge_cases.tex` (Disabled route identity) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D005 | SCI-MAP |
...
| `SCI-PTC-PRED-005` | `src/common/edge_cases.tex` (Centering null mode) | Rationale 3.1; compact crosswalk | Engineering falsifiable predictions | D017 | None |
...
| `SCI-PTC-PRED-008` | `src/common/edge_cases.tex` (Fit-excluded apply-allowed) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D007 | None |
...
| `SCI-PTC-PRED-029` | `src/common/edge_cases.tex` (Conditional covariance) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D014 | NOI |
...
| `SCI-PTC-PRED-039` | `src/common/edge_cases.tex` (Frozen component versus projection) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D010,Q002 | None |
| `SCI-PTC-PRED-040` | `src/common/edge_cases.tex` (Temporal versus detector action) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D010,Q002 | None |
...
| `SCI-PTC-PRED-042` | `src/common/edge_cases.tex` (Typed procedure state change) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D013 | None |
| `SCI-PTC-PRED-043` | `src/common/edge_cases.tex` (Candidate-evidence reconstruction) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D012 | Owner policy |
| `SCI-PTC-PRED-044` | `src/common/edge_cases.tex` (External-parent fail-closed) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D004,D014 | FRUIT |
| `SCI-PTC-PRED-045` | `src/common/edge_cases.tex` (Surrogate support transformation) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D006,D007 | VAL,NOI |
| `SCI-PTC-PRED-046` | `src/common/edge_cases.tex` (Astronomical-predicate typing) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D012,D013 | Owner policy |
| `SCI-PTC-PRED-047` | `src/common/edge_cases.tex` (Unavailable bias claim) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D010,D014 | NOI |
| `SCI-PTC-PRED-048` | `src/common/edge_cases.tex` (Independent product and response states) | Rationale ; compact crosswalk | Engineering falsifiable predictions | D005,D013 | None |
