...
| `SCI-PTC-REQ-008` | `src/common/requirements.tex` (Requested operation) | Rationale 4.1; compact crosswalk | Engineering normative requirements | D010,D012,WP1-D006--D008 | Owner policy |
...
| `SCI-PTC-REQ-012` | `src/common/requirements.tex` (Complete named-use decision) | Rationale 2.1; compact crosswalk | Engineering normative requirements | D007,WP1-D002--D003 | PTC and named-use owners,VAL |
...
| `SCI-PTC-REQ-019` | `src/common/requirements.tex` (Declared estimand) | Rationale 1.2; compact crosswalk | Engineering normative requirements | D004,D014,WP1-D001 | None |
...
| `SCI-PTC-REQ-033` | `src/common/requirements.tex` (Data-derived grouping) | Rationale 3.2; compact crosswalk | Engineering normative requirements | D011,WP1-D006 | None |
| `SCI-PTC-REQ-034` | `src/common/requirements.tex` (Finite candidate set) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
| `SCI-PTC-REQ-035` | `src/common/requirements.tex` (Conjunctive automatic admission) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
| `SCI-PTC-REQ-036` | `src/common/requirements.tex` (No compensating score) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
| `SCI-PTC-REQ-037` | `src/common/requirements.tex` (Ordering and ties) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
| `SCI-PTC-REQ-038` | `src/common/requirements.tex` (Nonnested candidates) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
| `SCI-PTC-REQ-039` | `src/common/requirements.tex` (Failed candidate resolution) | Rationale 4.3; compact crosswalk | Engineering normative requirements | D012,WP1-D007 | Owner policy |
...
| `SCI-PTC-REQ-041` | `src/common/requirements.tex` (Source-mask limit) | Rationale 3.3; compact crosswalk | Engineering normative requirements | D004,D014,WP1-D008 | AST,ALIGN |
| `SCI-PTC-REQ-042` | `src/common/requirements.tex` (Diagnostic definition) | Rationale 5.1; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | Owner policy |
| `SCI-PTC-REQ-043` | `src/common/requirements.tex` (Pathology discrimination) | Rationale 5.1; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | Owner policy |
| `SCI-PTC-REQ-044` | `src/common/requirements.tex` (Owner-controlled thresholds) | Rationale 5.1; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | Owner policy |
| `SCI-PTC-REQ-045` | `src/common/requirements.tex` (Finite refinement) | Rationale 5.2; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | None |
| `SCI-PTC-REQ-046` | `src/common/requirements.tex` (Immutable-parent refit) | Rationale 5.2; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | SCI-CAL |
| `SCI-PTC-REQ-047` | `src/common/requirements.tex` (Non-fit dispositions) | Rationale 5.2; compact crosswalk | Engineering normative requirements | D007,D009,WP1-D008 | VAL |
| `SCI-PTC-REQ-048` | `src/common/requirements.tex` (Refinement stopping state) | Rationale 5.2; compact crosswalk | Engineering normative requirements | D009,WP1-D008 | Owner policy |
...
| `SCI-PTC-REQ-062` | `src/common/requirements.tex` (Fixed-state companion) | Rationale 7.1; compact crosswalk | Engineering normative requirements | D013,Q002,WP1-D001,D006,D008 | SCI-RTC,SCI-CAL |
...
| `SCI-PTC-REQ-073` | `src/common/requirements.tex` (Typed fallback) | Rationale 8.2; compact crosswalk | Engineering normative requirements | D003,D007,WP1-D007 | None |
| `SCI-PTC-REQ-074` | `src/common/requirements.tex` (Insufficient support) | Rationale 8.2; compact crosswalk | Engineering normative requirements | D007,D012,WP1-D007 | None |
...
| `SCI-PTC-REQ-076` | `src/common/requirements.tex` (RTC-terminal disabled route) | Rationale 8.3; compact crosswalk | Engineering normative requirements | D005,WP1-D005 | SCI-RTC |
| `SCI-PTC-REQ-077` | `src/common/requirements.tex` (No ordinary PTC-free map route) | Rationale 8.3; compact crosswalk | Engineering normative requirements | D005,WP1-D005,D007 | SCI-MAP |
...
| `SCI-PTC-PRED-012` | `src/common/edge_cases.tex` (Configured-group isolation) | Rationale 3.2; compact crosswalk | Engineering falsifiable predictions | D011,WP1-D006 | None |
| `SCI-PTC-PRED-013` | `src/common/edge_cases.tex` (Grouping alternatives) | Rationale 3.2; compact crosswalk | Engineering falsifiable predictions | D011,WP1-D006 | None |
...
| `SCI-PTC-PRED-017` | `src/common/edge_cases.tex` (Future least-aggressive selection) | Rationale 4.3; compact crosswalk | Engineering falsifiable predictions | D012,WP1-D007 | Owner policy |
| `SCI-PTC-PRED-018` | `src/common/edge_cases.tex` (Future no-compensating metric) | Rationale 4.3; compact crosswalk | Engineering falsifiable predictions | D012,WP1-D007 | Owner policy |
| `SCI-PTC-PRED-019` | `src/common/edge_cases.tex` (Future deterministic tie) | Rationale 4.3; compact crosswalk | Engineering falsifiable predictions | D012,WP1-D007 | Owner policy |
| `SCI-PTC-PRED-020` | `src/common/edge_cases.tex` (Failed candidate resolution) | Rationale 4.3; compact crosswalk | Engineering falsifiable predictions | D012,WP1-D007 | Owner policy |
| `SCI-PTC-PRED-021` | `src/common/edge_cases.tex` (Immutable-parent refinement) | Rationale 5.2; compact crosswalk | Engineering falsifiable predictions | D009,WP1-D008 | SCI-CAL |
...
| `SCI-PTC-PRED-023` | `src/common/edge_cases.tex` (Refinement oscillation) | Rationale 5.2; compact crosswalk | Engineering falsifiable predictions | D009,WP1-D008 | Owner policy |
| `SCI-PTC-PRED-024` | `src/common/edge_cases.tex` (Diagnostic population dependence) | Rationale 5.1; compact crosswalk | Engineering falsifiable predictions | D009,WP1-D008 | Owner policy |
| `SCI-PTC-PRED-025` | `src/common/edge_cases.tex` (Diagnostic-only $r$ inertia) | Rationale 4.2; compact crosswalk | Engineering falsifiable predictions | D008,Q001,WP1-D008 | SCI-RTC |
...
| `SCI-PTC-PRED-039` | `src/common/edge_cases.tex` (Frozen component versus projection) | Rationale 4.2; compact crosswalk | Engineering falsifiable predictions | D010,Q002,WP1-D001 | None |
...
| `SCI-PTC-PRED-048` | `src/common/edge_cases.tex` (Independent product and response states) | Rationale 8.3; compact crosswalk | Engineering falsifiable predictions | D005,D013,WP1-D005 | None |
...
| `SCI-PTC-PRED-051` | `src/common/edge_cases.tex` (Network support isolation) | Rationale 2.1 and 3.2; compact crosswalk | Engineering falsifiable predictions | WP1-D006 | None |
| `SCI-PTC-PRED-052` | `src/common/edge_cases.tex` (Array cross-network coupling) | Rationale 3.2; compact crosswalk | Engineering falsifiable predictions | WP1-D006 | None |
| `SCI-PTC-PRED-053` | `src/common/edge_cases.tex` (Rank-zero failure) | Rationale 4.3 and 8.3; compact crosswalk | Engineering falsifiable predictions | WP1-D005,D007 | None |
| `SCI-PTC-PRED-054` | `src/common/edge_cases.tex` (Unrealizable-rank failure) | Rationale 4.3 and 8.2; compact crosswalk | Engineering falsifiable predictions | WP1-D007 | None |
| `SCI-PTC-PRED-055` | `src/common/edge_cases.tex` (Configured-rank reproducibility) | Rationale 4.3; compact crosswalk | Engineering falsifiable predictions | WP1-D007 | None |
| `SCI-PTC-PRED-056` | `src/common/edge_cases.tex` (Full-support projector reduction) | Rationale 4.2; compact crosswalk | Engineering falsifiable predictions | WP1-D006 | None |
