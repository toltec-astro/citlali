...
| VAL | Define reusable precedence/eligibility consumption for PTC's per-cause stage-support decisions, detector refinement, influence, and response status | Deferred to VAL |
