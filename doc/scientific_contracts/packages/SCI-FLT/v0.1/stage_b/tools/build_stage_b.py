#!/usr/bin/env python3
"""Build the deterministic SCI-FLT-FIXED v0.1 freeze-candidate PDF set."""
...
OWNER_DIRECTIVES = [
    ...
    SOURCE_DIR / "OWNER_DIRECTIVE_FINAL_MICRO_REPAIR.txt",
]
...
DOCUMENTS = [
    {
        ...
        "output": "SCI-FLT-FIXED-v0.1-NORMATIVE-CORE-freeze-candidate.pdf",
        "identity": "SCI-FLT-FIXED-NORMATIVE-CORE v0.1/freeze-candidate",
        "short": "SCI-FLT-FIXED Normative Core",
    },
    {
        "source": "SCIENTIST_RATIONALE.md",
        "output": "SCI-FLT-FIXED-v0.1-SCIENTIST-RATIONALE-freeze-candidate.pdf",
        "identity": "SCI-FLT-FIXED-SCIENTIST-RATIONALE v0.1/freeze-candidate",
        "short": "SCI-FLT-FIXED Scientist Rationale",
    },
    {
        "source": "ENGINEERING_CONFORMANCE.md",
        "output": "SCI-FLT-FIXED-v0.1-ENGINEERING-CONFORMANCE-freeze-candidate.pdf",
        "identity": "SCI-FLT-FIXED-ENGINEERING-CONFORMANCE v0.1/freeze-candidate",
...
SUPPORTING_SOURCES = [
    ...
    "OWNER_DIRECTIVE_FINAL_MICRO_REPAIR.txt",
    ...
    "NUMERICAL_DOMAIN_PARTIAL_FUNCTION_AMENDMENT.md",
    "ZERO_OPERATOR_DOMAIN_AMENDMENT.md",
    "SCIENTIFIC_REPRESENTATION_IDENTITY_AMENDMENT.md",
    "EMPTY_SUPPORT_PUBLICATION_CANDIDATE_AMENDMENT.md",
...
def draw_page(canvas_obj, document, short_title: str) -> None:
    ...
    canvas_obj.drawRightString(width - 0.72 * inch, height - 0.41 * inch, "Conditional freeze candidate - owner signature required")
...
def build_pdf(
    ...
    binding_lines = [
        ...
        f"final owner directive SHA-256: {sha256(OWNER_DIRECTIVES[3])}",
    ...
    document = SimpleDocTemplate(
        ...
        keywords="SCI-FLT-FIXED, scientific contract, conditional freeze candidate",
    )
    document.build(
        story,
...
def build(output_dir: Path, binding_path: Path) -> dict:
    ...
    binding = {
        "schema_version": "1.0",
        "record_identity": "SCI-FLT-FIXED-STAGE-B-BUILD-BINDING v0.1/freeze-candidate",
        "status": "deterministic conditional-freeze-candidate build record; owner signature required; no scientific freeze or implementation approval claim",
