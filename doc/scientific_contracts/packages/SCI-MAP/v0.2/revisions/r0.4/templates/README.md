# SCI-MAP v0.2/r0.4 machine-readable prospective templates
...
| `VAL_HANDOFF_DECISION_RECORD.schema.json` | Six r0.4 candidate profile-status axes plus the currently unavailable PTC/VAL object-decision record. |
