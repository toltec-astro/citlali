# SCI-MAP coadd aggregate profile v0.2/r0.4 candidate
...
`SCI-VAL_PROFILE_REGISTRY v0.1/r0.3-map-v0.2-r0.4-candidate-2026-09-08` and
...
`SCI-MAP:map_upstream_admission@2` under the r0.4 candidate binding proposal.
