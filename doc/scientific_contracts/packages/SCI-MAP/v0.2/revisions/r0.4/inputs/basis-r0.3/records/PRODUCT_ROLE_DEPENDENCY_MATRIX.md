# SCI-MAP v0.2/r0.3 product-role dependency matrix

Status: **CANDIDATE for scientific-owner disposition**. Exact role identities
are proposed in
`../profiles/SCI-MAP_PRODUCT_ROLE_REGISTRY_v0.2_r0.3_CANDIDATE.md`. Normative
...
`SCI-MAP:map_upstream_admission@2`, with the r0.3 candidate source binding.
...
Both r0.3 profile semantics are candidate; owner approval, Registry
