...
These three local tools support only the SCI-MAP r0.4 source/PDF delivery requested by the owner. They consume this package, isolated document-build directories, and the document tools explicitly recorded in the build recipe. They do not inspect or modify Citlali application sources, configuration, tests, or data.
