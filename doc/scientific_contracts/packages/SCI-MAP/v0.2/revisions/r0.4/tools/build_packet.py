...
CORE = ['SCI-MAP-v0.2_SHARED_AUTHORITY_r0.4.tex'] + [f'common/{x}.tex' for x in ('notation','definitions','equations','assumptions','requirements','edge_cases')]
CORE_ID = 'SCI-MAP-v0.2-SHARED-AUTHORITY/r0.4'
MANIFEST = 'doc/scientific_contracts/studies/SCI_MAP_POST_FREEZE_RECONCILIATION_2026-09-07/AUTHOR_REFERENCES.json'
DIRECTIVE = 'owner/SCI_MAP_R04_OWNER_DIRECTIVE.txt'
...
def prepare(args):
    ...
    build_id = 'SCI-MAP-R04-DOCUMENT-BUILD/' + attempt.name
    data = {
    ...
    for view, (entry, _) in VIEWS.items():
        ...
        rows = [
            ...
            ('Contract / document', 'SCI-MAP v0.2 / r0.4'),
