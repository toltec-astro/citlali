# SCI-MAP v0.2/r0.2 PRED-014 and aggregate-response rule
...
`../profiles/SCI-MAP_COADD_AGGREGATE_PROFILE_v0.2_r0.2_CANDIDATE.md`.
...
| Named member response incompatible; response-bearing coadd requested over an existing base parent | Identical to the existing parent | Stronger role blocked/unavailable | Do not mutate or subset the parent. |
...
register and evaluate the MAP-authored policy but does not aggregate, place,
or define it.
