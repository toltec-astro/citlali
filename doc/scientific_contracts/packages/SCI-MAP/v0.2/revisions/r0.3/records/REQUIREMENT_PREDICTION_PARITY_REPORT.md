# SCI-MAP v0.2/r0.3 requirement and prediction parity report
...
| --- | --- | --- |
| Six candidate profile-status axes | REQ-004, 006, 037, 039, 046 | PRED-010, 013--017 |
| Empty-support disposition | REQ-009, 012, 031--033, 039, 047--048 | PRED-012, 015, 017, 025 |
| Product realization versus attempt outcome | REQ-009, 031, 036, 043, 046--048 | PRED-012--017, 025 |
| Response-family-qualified coadd | REQ-036--037, 040, 043, 046 | PRED-013--016 |
| Six product roles and aggregate response rule | REQ-036--041, 043, 046--050 | PRED-013--019 |
| Stable full-procedure comparison record | REQ-008, 016--017, 040, 043, 046, 050 | PRED-005--006, 013--016 |
| Exact document roles | REQ-001 and all view authority statements | ECS/rationale fixture routing only; no new PRED ID |
