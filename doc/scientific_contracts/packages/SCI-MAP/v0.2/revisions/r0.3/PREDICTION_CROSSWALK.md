# SCI-MAP v0.2/r0.3 prediction crosswalk
...
| SCI-MAP-PRED-025 | REQ-009, REQ-012, REQ-031--034, REQ-047--048 | Zero/non-finite/unrepresentable aggregate, index, or publication failure never becomes a valid product; authorized empty support retains applied evidence with `not_produced` and no product. |
