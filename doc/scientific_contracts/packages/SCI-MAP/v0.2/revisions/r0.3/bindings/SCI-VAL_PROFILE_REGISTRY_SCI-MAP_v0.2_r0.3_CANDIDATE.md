# SCI-VAL candidate Profile Registry generation for SCI-MAP v0.2/r0.3

Registry identity:
`SCI-VAL_PROFILE_REGISTRY v0.1/r0.3-map-v0.2-r0.3-candidate-2026-09-08`
...
| Field | Exact value |
| --- | --- |
| Shared authority identity | `SCI-MAP-v0.2-SHARED-AUTHORITY/r0.3` |
| Shared authority aggregate SHA-256 | `45b863cab2713075656e11f5d6008f377879079f0d6f52b08ac579bd04ada4c6` |
...
| Product-role Registry | `profiles/SCI-MAP_PRODUCT_ROLE_REGISTRY_v0.2_r0.3_CANDIDATE.md`; SHA-256 `a8156c9f907c8f8081b26806d33c36b55e214651ced5897e1d4441e6c8886ccb` |

## Profile records

| Exact profile identity | Source record and SHA-256 | Candidate registration |
| --- | --- | --- |
| `SCI-MAP:map_upstream_admission@2` | `profiles/SCI-MAP_OCCURRENCE_ADMISSION_PROFILE_v0.2_r0.3_CANDIDATE.md`; `3eff5e0698d66b33213d691cd447db32de05f97f05f7b232414d5867f58759b9` | Proposed r0.3 compatible generation; predicates/identity unchanged; no present registration or evaluation. Earlier bindings/evaluations remain exact. |
| `SCI-MAP:observation_coadd_admission@2` | `profiles/SCI-MAP_COADD_AGGREGATE_PROFILE_v0.2_r0.3_CANDIDATE.md`; `ca42154c3ba25fa28d7fad50040e3498f5ae536fc77febccee7ce693d131ea61` | Proposed owner-governed aggregate profile with role/family/no-support repairs. Historical `@1` is immutable; no current evaluation. |
| `SCI-MAP:one_hot_containing_pixel@1` | Shared authority aggregate above; exact unchanged rule inherited from the admitted basis. | Proposed compatible r0.3 source-generation association only; lower-inclusive, upper-exclusive unique containing pixel with outer-boundary loss. |
| `SCI-MAP:uniform_observation_coadd_coefficient@1` | Shared authority aggregate above; exact unchanged rule inherited from the admitted basis. | Proposed compatible r0.3 source-generation association only; exact dimensionless `u_op=1` for every admitted observation row. |
