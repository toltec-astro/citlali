...
| Authoritative source | Owner-approved successor bytes of this profile; exact `SCI-PTC_TO_SCI-JINC v0.1/r0.1`; exact `SCI-AST_TO_SCI-JINC v0.1/r0.1`; frozen SCI-PTC v0.1/r0.5 freeze record SHA-256 `8357961a49272adc40e27a8aa9e760e0d01ff2419ae2c88a62c0f93c9f959e66`; frozen SCI-AST v0.1/r0.3 source manifest SHA-256 `b54b6013750540f28aad02339a60bf36078980dc53b132beab73069d66ef3601`; and the future exact SCI-VAL registry successor. |
...
| Required permissions | Exact realized PTC product exists; `SCI-PTC:output_retention@1` is requested, applicable, eligible and realized; transformed signal and source identity are available; one exact PTC-owner-selected JINC-facing coefficient family/value is typed available; its coefficient/QC record permits JINC use; the exact same-`n` AST RTC-grid continuous coordinate is structurally bound and AST-valid; all required source, generation and lifecycle bindings are compatible. |
| Decisive exclusions | PTC-disabled/no-product; direct CAL fallback or inferred no-op PTC; output-retention ineligible; direct synthesized or replaced representative source for ordinary JINC signal support; incompatible signal/coordinate parents; incompatible generations; coefficient/QC exclusion; absent stable array identity; or boundary/profile/source-version mismatch. |
...
| Exceptions | None for exact occurrence/parent/generation binding, realized PTC route, output-retention permission, direct synthesized/replaced exclusion, coefficient identity/QC permission, same-`n` AST binding, stable array identity, or exact source/profile identity. |
...
| Missing/conflicting behavior | Missing or conflicting applicability, identity, parent, generation, required permission, coefficient family/value/QC, coordinate, boundary, source or registry binding yields `applicability_unknown` and `decision_unavailable` where evaluable. A decisive false restriction yields `ineligible`; all restrictions true yields `eligible`. Causes and scopes remain exact. |
