...
| Coefficient-squared time | ODQ-104 authorizes `jinc_coefficient_squared_time` as the sole base-v0.1 time-support product, retains dimensionless `kappa_ip` as the squared object and every prohibited exposure/precision/significance interpretation, and defers a distinct physical-exposure product until an identified scientific use requires it. |
