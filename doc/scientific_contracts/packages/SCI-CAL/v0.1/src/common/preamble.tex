...
\hypersetup{
  ...
  pdfsubject={SCI-CAL v0.1 scientific contract draft}
}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{calgray}SCI-CAL v0.1 DRAFT}
...
\newcommand{\DraftNotice}{%
  ...
  \fcolorbox{calblue}{callight}{%
    ...
    \small\textbf{Draft authority boundary.}
    This is an implementation-blind scientific contract draft. It defines
    proposed scientific meaning and falsifiable conformance conditions. It is
...
\newcommand{\MakeContractTitle}[2]{%
  ...
  {\large Version 0.1 / \DocRevision{} - DRAFT}\\[0.12in]
  {\large 2026-08-16}\\[0.48in]
  \fcolorbox{calblue}{callight}{%
