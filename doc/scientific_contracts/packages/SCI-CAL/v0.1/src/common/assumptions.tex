...
\item[\Assump{001}: upstream sample authority.]
  ...
  approved upstream authority. The physical observable, unit, sign,
  preprocessing, normalization, stream scope, and valid multiplicative domain
  are separately approved. SCI-CAL neither chooses nor rederives them; Q01
  records their present unresolved status.
...
\item[\Assump{005}: coefficient direction and reference plane.]
  ...
  and disposition of any pointing-derived correction. Q03--Q05 record the
  present unresolved scientific authority for those meanings.
...
\item[\Assump{010}: passband limitation.]
  ...
  response weighting and carries unavailable passband uncertainty. Q05 also
  leaves compatibility among source-factor, atmosphere, and reported-output
  spectral conventions unresolved; sharing a passband identifier does not by
  itself establish that compatibility.
