...
\Req{013}, \Req{014}, \Req{015}, \Req{016} & Sections~\ref{sec:model}--\ref{sec:flxscale}; Q03--Q04 & Generating record, child transform, transfer domain, and once-only multiplier \\
...
\Req{021}, \Req{022}, \Req{023}, \Req{024}, \Req{025}, \Req{026} & Section~\ref{sec:atmosphere}; Appendix~\ref{app:formal} & Atmosphere meaning, temporal/operator support, invariants, and Q06-only closure \\
\Req{027}, \Req{028}, \Req{029}, \Req{030}, \Req{031} & Sections~\ref{sec:atmosphere}, \ref{sec:validity}; Q05--Q07 & Opacity policy, coherent quality, passband limits, and spectral compatibility \\
\Req{032}, \Req{033}, \Req{034} & Section~\ref{sec:uncertainty} & Conditional covariance, variance, weight, unavailable state \\
\Req{035}, \Req{036}, \Req{037}, \Req{038}, \Req{039} & Sections~\ref{sec:model}, \ref{sec:uncertainty}; Appendix~\ref{app:formal}; Q02 & Nuisance scopes, total covariance, companions, and local-versus-end-to-end response \\
...
\Req{045}, \Req{046}, \Req{047}, \Req{048} & Sections~\ref{sec:flxscale}, \ref{sec:validity}; Appendix~\ref{app:states}; Q01--Q09 & Claim-specific states, reasons, complete ownership/delivery lineage, and product links \\
\Req{049}, \Req{050} & Sections~\ref{sec:response}, \ref{sec:validation}; Q01--Q09 & Separate physical, transfer, broadband, response, structural, fidelity, and performance claims \\
\bottomrule
\end{longtable}
