...
\newcommand{\DocShortTitle}{Science-Team Rationale r0.3}
\newcommand{\DocPdfTitle}{SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.3 Draft}
\input{common/preamble.tex}
\fancyhead[L]{\small\color{calgray}SCI-CAL v0.1 -- Science-Team Rationale r0.3 DRAFT}
\fancyhead[R]{}
\hypersetup{pdftitle={SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.3 Draft},pdfauthor={SCI-CAL scientific owner review revision},pdfsubject={SCI-CAL v0.1 scientist-facing rationale r0.3}}
...
{\large Rationale revision 0.3 -- DRAFT}\\[0.10in]
...
malformed, or unsupported values are outside scope. The thresholds are adopted
v0.1 policy limits, not laws of atmospheric physics and not the numerical
support of the missing operator. The materials reviewed do not document their
scientific rationale, the authority that defines coherent segments, or the
...
\caption{Decision register for science-rationale revision r0.3.}\label{tab:decisions}\\
...
assumptions 001--011, and edge predictions 001--030. Rationale revision r0.3
...
\input{scientific-crosswalk-r0.3.tex}
\end{document}
