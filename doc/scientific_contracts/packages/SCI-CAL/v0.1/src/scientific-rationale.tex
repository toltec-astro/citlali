...
\newcommand{\DocShortTitle}{Science-Team Rationale r0.4}
\newcommand{\DocPdfTitle}{SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.4 Draft}
\input{common/preamble.tex}
\fancyhead[L]{\small\color{calgray}SCI-CAL v0.1 -- Science-Team Rationale r0.4 DRAFT}
\fancyhead[R]{}
\hypersetup{pdftitle={SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.4 Draft},pdfauthor={SCI-CAL scientific owner review revision},pdfsubject={SCI-CAL v0.1 scientist-facing rationale r0.4}}
...
{\large Rationale revision 0.4 -- DRAFT}\\[0.10in]
{\large 2026-08-20}\\[0.50in]
...
\caption{Decision register for science-rationale revision r0.4.}\label{tab:decisions}\\
...
assumptions 001--011, and edge predictions 001--030. Rationale revision r0.4
...
\input{scientific-crosswalk-r0.4.tex}
\end{document}
