...
\newcommand{\DocPdfTitle}{SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.5 Draft}
\input{common/preamble.tex}
\fancyhead[L]{\small\color{calgray}SCI-CAL v0.1 -- Science-Team Rationale r0.5 DRAFT}
\fancyhead[R]{}
\hypersetup{pdftitle={SCI-CAL v0.1 TolTEC Timestream Calibration - Science-Team Rationale r0.5 Draft},pdfauthor={SCI-CAL scientific owner review revision},pdfsubject={SCI-CAL v0.1 scientist-facing rationale r0.5}}
...
{\large Rationale revision 0.5 -- DRAFT}\\[0.10in]
...
\input{scientific-crosswalk-r0.5.tex}
\end{document}
