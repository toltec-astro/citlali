# SCI-CAL v0.2 Scientist/Engineering Crosswalk
...
| `ASM-003` | Calibrator-to-target section; Q03--Q04 | Selected immutable APT and association |
...
| `REQ-049`, `REQ-050` | Validation; Q09 | Separate claim layers and preregistered evidence |
...
draft crosswalk remains in `CROSSWALK.md`.
