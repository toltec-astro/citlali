...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A scope and exact packet owner-approved `2026-08-17`; `RTC-SCOPE-D004` permits valid-compatible-`flxscale` donor scaling | No implementation-blind contract draft yet; scientific authority not approved | Draft only from the exact approved three-item packet; retain eight open downstream owner decisions | Fresh implementation-blind Stage B author, then manager and scientific-owner review |
