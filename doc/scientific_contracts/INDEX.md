...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Weighting closed; prior candidates rejected; central-domain starlet comparison complete 2026-09-12 | Edge/domain hypothesis supported; tested 60-arcsec reconstruction candidate not accepted; no production or qualification | [Central-domain result](../../validation/fruit_point_starlet_central_domain_2026-09-12/SCIENTIFIC_REPORT.md): null admissions 5/6 to 0/6; background 3/3 to 0/3. Source solves remain unavailable; offset-coma domain loss alone forces >=29.01% image error. 174 estimator calls, zero new PTC passes. Next bounded owner decision may separate source-evidence domain from model extent. 129081 historically characterized and reserved |
