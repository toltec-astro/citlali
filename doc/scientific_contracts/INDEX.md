...
| [SCI-BEAM — detector beam inference, calibration candidates, QC, and products](packages/SCI-BEAM/v0.1/README.md) | Owner-approved v0.1 scope; separate from active ALIGN/AST | Stage B `r0.1` draft manager-reviewed: 46 requirements, 24 predictions, two rendered views; scientific authority not accepted | Review seven retained owner questions and the scientific rationale | Scientific-owner review, then fresh implementation-blind consistency review |
