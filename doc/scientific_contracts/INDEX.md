...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Conditional scientific-core scope and narrow sequence exception approved 2026-09-06; corrected Stage A r0.2 draft under owner review | No numerical profile admitted, no qualified replacement and no Stage B author launched; r0.1 readiness request withdrawn after instruction review | Review the corrected scientific input/output boundary and individual decision dispositions; exact packet approval and explicit launch remain outstanding | Review the [r0.2 Stage A outputs](packages/SCI-FRUIT/v0.1/scientific_core/r0.2/README.md); preserve historical control and separate later numerical evidence gates |
