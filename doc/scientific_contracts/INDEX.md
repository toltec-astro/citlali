...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A scope and packet owner-approved `2026-08-17`; r0.3 bounded iterative notch-plan directive received `2026-08-18` | Stage B v0.1/r0.3 revision complete: 82 requirements, 46 predictions, 38-page rationale, 29-page engineering view; scientific authority not approved | Review 18 author decisions and 50-entry ledger: 45 open, one conditional, four deferred | Scientific-owner review of the r0.3 two-view draft; no conformity or validation work yet |
