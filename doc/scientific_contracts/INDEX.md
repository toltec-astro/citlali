...
coordinate/projection boundaries without deciding MAP-local projection
classes.
...
is now proceeding only in its separately governed Stage A lane.
...
new clean-room successor. No implementation, performance, production, MAP, or
finding-closure claim follows from that publication.
...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope; bounded PTC-handoff Stage B r0.1 author return manager-reviewed `2026-08-26` | Science-team rationale r0.3 house version frozen; canonical clauses unchanged; r0.1 return not accepted for integration; 52 requirement IDs and 25 prediction IDs retained; scientific authority not frozen | Preserve all nine open decisions; OD-003/004/008 may be narrowed only after a corrected return, with projection class and normalization still open | Approve a successor packet containing the exact r0.1 return and manager correction directive, then commission bounded r0.2 |
