...
| [SCI-NOI — noise realizations and empirical uncertainty](packages/SCI-NOI/v0.1/README.md) | Recovery-first Stage A packet returned for owner review on `2026-08-29` | Stage B not commissioned; no normative source or PDF exists | `SCI-NOI-ODQ-101` first: ordinary fixed-state/relearned method disposition; ODQ-102--110 remain bounded and open | Walk through owner decisions beginning with ODQ-101, then approve or revise the exact content-bound author packet |
