...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A frozen; generic Stage B v0.1/r0.4 conditionally frozen; ordinary-MAP scope and residual-relearning direction approved 2026-09-08 | Targeted paper method/boundary r0.2 complete; fresh residual learning then fixed per-pass Apply; prior r0.1, historical JINC control and exact MAP r0.7.1 preserved | Remaining method combination and exact residual-PTC learn/apply/rejoined-MAP amendments pending; effective coefficient/PTC/support bindings required | Review the [residual-relearning successor](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/r0.2/README.md); scope and learning schedule are resolved, no author dispatch or experiment approval |
