...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Three targeted clarifications locked: recommended POINT ordering, reference-only fixed support and binary flux estimator; r0.3 and frozen/historical products preserved | Q02 annex unchanged/proposed/not adopted; numerical policy, effective-plan/support and evidence/execution bindings remain unavailable | Review [Q02 A–C recommendations and required profile-version clarification](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/q02_review/r0.1/README.md); all remain pending. Q01 frozen; no amendment adoption, implementation or execution approved |
