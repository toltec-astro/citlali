...
| [SCI-BEAM — detector beam inference, calibration candidates, QC, and products](packages/SCI-BEAM/v0.1/README.md) | Owner-approved v0.1 scope; separate from active ALIGN/AST | Stage B packet content-bound; fresh implementation-blind author authorized | Review new author questions and the resulting draft; scientific authority not yet accepted | Commission the exact packet; then perform manager and independent consistency review |
