...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A scope and packet owner-approved `2026-08-17`; r0.2 learn--resolve--apply directive received `2026-08-18` | Stage B v0.1/r0.2 revision complete: 70 requirements, 38 predictions, 33-page rationale, 24-page engineering view; scientific authority not approved | Review 18 author decisions and 36-entry ledger: 31 open, one conditional, four deferred | Scientific-owner review of the r0.2 two-view draft; no conformity or validation work yet |
