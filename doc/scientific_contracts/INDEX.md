...
| --- | --- | --- | --- | --- |
| [SCI-CAL — detector calibration, extinction, and signal transfer](packages/SCI-CAL/v0.1/README.md) | Owner-approved scientific contract v0.1 scope | Science-team rationale r0.3 final cleanup complete; engineering conformance r0.2 alignment repair complete; scientific authority not frozen | Resolve or disposition Q01--Q09, including `xs`, `flxscale` transfer, broadband convention, and numeric atmosphere authority | Fresh implementation-blind consistency review, then explicit scientific-owner freeze disposition |
