...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | POINT operational-gate trial complete 2026-09-12; 1-arcsec criterion owner-approved for this test | Candidate not accepted; recommend bounded completion/evaluator revision; no primary improvement or qualification | [Trial result](../../validation/fruit_point_operational_gate_trial_2026-09-12/SCIENTIFIC_REPORT.md): 167 cleaning calls; central null benefit retained but no completed synthetic source trajectory. 19/21 failed solves meet gradient tolerance; shared gate withholds eight reference centroids within 1 arcsec. Real C/P wall 43.51/8.07 s. Next explicit completion and use-specific availability decision; 129081 historically characterized and reserved |
