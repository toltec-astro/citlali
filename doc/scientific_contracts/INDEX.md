...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.2/SCIENTIFIC_OWNER_FREEZE_R0.4.md) | Approved scope and all nine owner decisions incorporated; predecessor bytes preserved | **Generic scientific authority frozen** at v0.2/r0.4; 52 requirements and 25 predictions; exact profiles and five final identities approved and registered | Owner-approved [contractual activation](acceptance/SCI_MAP_PROFILE_ACTIVATION_2026-09-09/ACTIVATION_RECORD.md) takes effect on reviewed canonical incorporation; object-specific facts and decisions remain required | Preserve frozen science; no application, numerical-execution, production or FRUIT transition is implied |
...
| [SCI-VAL — sample/detector validity, flags, and map eligibility](packages/SCI-VAL/v0.1/README.md) | Owner-approved r0.3 Core; all prior Registry/source generations and evaluations preserved | Core remains r0.3 with 49 requirements and 24 predictions; exact MAP r0.4 profiles and source bindings registered | The exact MAP generation becomes contractually evaluable on [reviewed canonical activation](acceptance/SCI_MAP_PROFILE_ACTIVATION_2026-09-09/ACTIVATION_RECORD.md); no other inherited profile is activated or rebound; four NOI r0.5 successors remain unapproved/unbound | VAL evaluates only independently requested exact objects with required facts and artifact verification; no numerical parent or implementation qualification is supplied |
| [SCI-NOI — realization ensembles, empirical uncertainty, and standardized signal](packages/SCI-NOI/v0.1/README.md) | Recovery-first Stage A, owner decisions, implementation-blind Stage B, and bounded r0.5 target-law closure complete | **Scientific authority frozen** at v0.1/r0.5 snapshot commit `2303daf7061a19945a6333099d33dd559cf2abf8`, with approval provenance at branch tip `f28d7a2617160febca85c1c40e6f7ba7494e266e`; freeze-manifest SHA-256 `b6915186424dd52d7c94fb0df47db91654d3c20cf4b3fa6ab98c3554626d8bfc` | Four r0.5 profile successors remain proposed, unapproved, Registry-unbound and unevaluable; uniform authority is admitted and MAP owner policy is incorporated in frozen v0.2/r0.4; MAP object gates (contractual activation has its separate reviewed disposition), transformed/Wiener/FRUIT authorities and actual numerical-parent gates remain | Preserve frozen r0.5 and the [current MAP activation boundary](acceptance/SCI_MAP_PROFILE_ACTIVATION_2026-09-09/ACTIVATION_RECORD.md); later profile admission or scientific correction needs separate authorization; the preserved NOI code candidate remains paused in this task and no implementation qualification is claimed |
