...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope; bounded PTC-handoff corrective integration rendered `2026-08-26` | Formal, rationale, and engineering views synchronized at r0.4; 52 requirement IDs, 25 prediction IDs, and nine open decisions retained; scientific authority not frozen | OD-003/004/008 narrowed without closure; projection class/normalization, response claim minimums, and covariance persistence remain open | Scientific-owner review of the rendered r0.4 PDFs; no conformity, validation, freeze, or readiness claim |
