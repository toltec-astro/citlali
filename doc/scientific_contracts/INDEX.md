...
| [SCI-JINC — signed-coefficient JINC gridding and response](packages/SCI-JINC/v0.1/README.md) | Final Stage A scope-repair candidate from `codex/scientific-contract-library@731f821954d4321509765720c6ba1838c95eff3d`; repaired Scope Brief and exact packet awaiting owner review | Recovered core and eight owner decisions classified; Schloerb LMT memo preserved and sanitized to generic-method excerpt; two-JINC formula closed; radial/pixel-average branches superseded; PTC/AST/profile/notation/geometry/grouping/product/response tables added; implementation/evidence quarantined; Stage B not commissioned | Approve exact packet and disposition the JINC coefficient family, TolTEC per-array radial scales/parameters, VAL registration, numerical/phase policy, and outside-center edge rule | Scientific-owner review of repaired Stage A bytes; do not commission Stage B before approval |
