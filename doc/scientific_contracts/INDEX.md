...
| [SCI-JINC — signed-coefficient JINC gridding and response](packages/SCI-JINC/v0.1/README.md) | Exact repaired Stage A scope and sanitized packet owner-approved on `2026-08-28` at `6639bff3d94b92ace8faf3e407ccaefd5a38ea1f` | Recovered core and eight owner decisions classified; Schloerb method excerpt admitted only for generic JINC/OTF ideas; two-JINC formula closed; TolTEC-specific values remain unavailable; implementation/evidence quarantined; Stage B not commissioned | Resolve or explicitly type the PTC coefficient family, TolTEC per-array scales/parameters, VAL successor, numerical/phase/cache policy, outside-center edge rule, and residual ledger gaps | Preserve approved bytes; resolve dispatch blockers; require a separate Stage B launch and explicit Ultra authorization if Ultra is to be used |
