...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | **Frozen v0.1/r0.7.1 preserved; eight later MAP owner decisions resolved** | Exact approved post-freeze choices recovered; first PTC uniform family/profile and separate MAP grant already admitted; [decision mapping](studies/SCI_MAP_POST_FREEZE_RECONCILIATION_2026-09-07/DECISION_RECONCILIATION.md) separates decision, incorporation and realization | No repeated owner choice in that MAP queue; versioned incorporation and successor source/boundary binding remain pending, with actual product/qualification gates separate | Prepare and review the successor under the approved Scope Brief and exact references; preserve frozen science and independent FRUIT development |
...
| [SCI-VAL — sample/detector validity, flags, and map eligibility](packages/SCI-VAL/v0.1/README.md) | Owner-approved r0.3 Core; immutable Registry successor chain preserves MAP/JINC/NOI history and admits the exact PTC uniform family/profile with separate MAP/JINC grants | Core remains r0.3 with 49 requirements and 24 predictions; exact Registry/source-binding successors include the September 6 uniform admission at `36176ac14abe23a5c331ba40af2bb86d3e97a7f6`; each policy remains authored by its named-use owner | No general VAL science question open; registration does not replace exact producer facts, numerical parents or owner authorities; the four NOI r0.5 profile successors remain unapproved/unbound | Preserve VAL as evaluator/registry and the admitted binding bytes; bind changed MAP sources through explicit successors; no conformity, validation, numerical-availability or readiness claim |
| [SCI-NOI — realization ensembles, empirical uncertainty, and standardized signal](packages/SCI-NOI/v0.1/README.md) | Recovery-first Stage A, owner decisions, implementation-blind Stage B, and bounded r0.5 target-law closure complete | **Scientific authority frozen** at v0.1/r0.5 snapshot commit `2303daf7061a19945a6333099d33dd559cf2abf8`, with approval provenance at branch tip `f28d7a2617160febca85c1c40e6f7ba7494e266e`; freeze-manifest SHA-256 `b6915186424dd52d7c94fb0df47db91654d3c20cf4b3fa6ab98c3554626d8bfc` | The four r0.5 profile successors remain proposed, unapproved, Registry-unbound, and unevaluable; uniform coefficient authority is separately admitted and MAP `coverage_cut` owner policy is decided, while MAP successor incorporation, transformed/Wiener/FRUIT authorities and actual numerical-parent gates remain; no conformity, generator validation, calibration, covariance-completeness, significance, performance, readiness, or production claim | Preserve the frozen r0.5 bytes and approval record; treat any later profile admission or scientific correction as a separately authorized successor |
