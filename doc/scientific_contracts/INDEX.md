...
| [SCI-JINC — signed-coefficient JINC gridding and response](packages/SCI-JINC/v0.1/README.md) | Stage A launched from `codex/scientific-contract-library@731f821954d4321509765720c6ba1838c95eff3d`; Scope Brief and exact packet awaiting owner review | Recovered core and eight owner decisions classified; radial/pixel-average branches explicitly superseded; later destination-ownership invariant abstracted; implementation/evidence quarantined; Stage B not commissioned | Approve or revise the exact packet and disposition the JINC-specific upstream coefficient, analytic identity, coordinate/admission, coadd, grouping, product, response/covariance, numerical-policy, and edge questions | Scientific-owner review of the bounded Stage A packet; do not commission Stage B before approval |
