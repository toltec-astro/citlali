...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A recovery and sanitized v0.1 Scope Brief drafted | No implementation-blind contract draft; scientific authority not approved | Approve, amend, or reject `RTC-SCOPE-D001--D016`, the eight-item open owner ledger, and exact three-item author packet | Scientific-owner scope and packet review; do not launch Stage B before approval |
