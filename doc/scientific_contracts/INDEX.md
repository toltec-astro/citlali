...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Q02-A (including S1) and Q02-B scientific substance approved; bounded U/N weighting test design approved for preparation | Q02-C open; no separate MAP-handoff approval or numerical family/source adoption. First-screen inputs, evidence and new numerical choices still gated | [Current Q02/Q05 direction](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/q02_review/WEIGHT_PRECISION_DIRECTION_2026-09-09.md): provisional 20% relative-weight precision goal approved. Prepare a correlation-aware assessment of shorter training windows on existing reductions; no new cutoff, pooling policy or run selected. 129081 remains reserved |
