...
| [SCI-JINC — signed-coefficient JINC gridding and response](packages/SCI-JINC/v0.1/README.md) | Approved predecessor Stage A packet at `6639bff3d94b92ace8faf3e407ccaefd5a38ea1f`; bounded ODQ-101/102B/103/104/105 successor candidate awaiting renewed exact-byte approval | ODQ-101 assigns the PTC coefficient registry/permissions; ODQ-102B types TolTEC numerical realization unavailable; ODQ-103 binds exact AST association/JINC admission; ODQ-104 makes `jinc_coefficient_squared_time` the sole base-v0.1 time-support product and defers physical exposure; ODQ-105 makes base v0.1 observation-only, permits same-observation incremental realization, and reserves cross-observation combination to a future complete-bundle boundary; frozen MAP/PTC/AST unchanged; Stage B not commissioned | Next: `SCI-JINC-ODQ-106`, independent per-array observation bundles, missing/unrequested-array cardinality and residual destination-identity disposition; then VAL successor, numerical/phase/cache policy, outside-center edge rule, residual gaps and `SCI-JINC-STAGE-A-Q002` | Review the exact ODQ-101/102B/103/104/105 successor bytes; do not commission Stage B before renewed approval and remaining dispositions |
