...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope | Manager-reviewed r0.1 two-view draft; 52 requirements and 25 predictions; scientific authority not frozen | Disposition `SCI-MAP-OD-001--007` | Owner science review; then a fresh implementation-blind two-view consistency review |
