...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope; bounded PTC-handoff Stage A packet and Ultra Stage B dispatch approved `2026-08-26` | Science-team rationale r0.3 house version frozen; current formal clauses unchanged; CI-001 resolved; 52 requirement IDs and 25 prediction IDs retained; scientific authority not frozen | Preserve `SCI-MAP-OD-001--009`; narrow only the portions answered by approved horizontal decisions, with projection class and normalization still open | Run the exact implementation-blind Stage B revision, then manager- and owner-review its bounded delta |
