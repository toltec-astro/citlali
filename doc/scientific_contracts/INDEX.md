...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Q02-A (including S1) and Q02-B scientific substance approved 2026-09-09; exact source/profile adoption remains pending | Q02-C remains open for detector-quality/noise weighting tests; no separate MAP-handoff approval. Frozen annex and all numerical/settings/evidence/execution gates retained | Review [A/B disposition and proposed bounded weighting tests](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/q02_review/r0.2/README.md); bind the first screen before execution. No amendment adoption, implementation, run or author dispatch |
