...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A frozen; generic Stage B v0.1/r0.4 accepted and conditionally scientifically frozen on 2026-09-08 | Exact freeze preserves all source/delivery bytes; numerical FRUIT methods remain unavailable; historical-control method recovery/proposal preparation approved | Review one proposed compact-source pointing, observation/raw JINC scope and its twenty-one method classes; upstream permissions remain explicit | Review the [historical-control method-scope r0.1 proposal](packages/SCI-FRUIT/v0.1/method_preparation/historical_control/r0.1/README.md); separate exact method, author-dispatch, assessment, experiment and qualification decisions remain gated |
