...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A scope and packet owner-approved `2026-08-17`; r0.4 owner decisions approved `2026-08-18` | Stage B v0.1/r0.4 revision complete: 82 requirements, 46 predictions, 39-page rationale, 28-page engineering view; scientific authority not approved | Review 18 author decisions and 50-entry ledger: 44 open, two resolved, four deferred | Scientific-owner review and freeze disposition for the r0.4 two-view draft; no conformity or validation work yet |
