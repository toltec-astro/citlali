...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Q02-A (including S1) and Q02-B scientific substance approved; bounded U/N weighting design and provisional 20% precision objective approved | Q02-C open; no separate MAP-handoff approval or numerical family/source adoption. First-screen inputs, evidence and new numerical choices still gated | [Q02 r0.5 diagnostic proposal](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/q02_review/r0.5/README.md): exact training-window, joint uncertainty, input and local execution bindings prepared for one decision. No run, certified precision or weighting policy; 129081 remains reserved |
