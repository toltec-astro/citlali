...
| [SCI-RTC — raw-timestream conditioning and temporal response](packages/SCI-RTC/v0.1/README.md) | Stage A scope and exact packet owner-approved `2026-08-17`; `RTC-SCOPE-D004` permits valid-compatible-`flxscale` donor scaling | Stage B v0.1/r0.1 manager-reviewed draft: 54 requirements, 26 predictions, 25-page rationale, 17-page engineering view; scientific authority not approved | Review 18 author decisions and 28-entry ledger: 23 open, one conditional, four deferred | Scientific-owner review of the r0.1 two-view draft; no conformity or validation work yet |
