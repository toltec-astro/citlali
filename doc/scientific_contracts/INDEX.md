...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A frozen; generic Stage B v0.1/r0.4 conditionally frozen 2026-09-08 | Numerical methods unavailable; completed recovery retained; r0.2 first-method proposal recommends ordinary MAP after owner-supplied sidebar, preserving historical JINC control | Review ordinary-MAP-first scope, explicit feedback projection and MAP-specific producer/support gates; no exact scope or numerical approval inferred | Review the [r0.2 ordinary-MAP method-scope proposal](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/r0.2/README.md); subsequent author, method, implementation and numerical gates remain separate |
