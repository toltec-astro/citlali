...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope | Exact three-part packet approved; implementation-blind authorship authorized | None at dispatch; unresolved scientific questions remain explicit in the brief | Dispatch a fresh implementation-blind author; do not rederive MAP-001 or absorb JINC/MAP-003 |
