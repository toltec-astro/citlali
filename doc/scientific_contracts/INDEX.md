...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Weighting closed; first coherent candidate rejected; owner-authorized relative-position prior test completed 2026-09-11 | Scoped empirical execution completed; production source/profile adoption and general qualification remain unavailable | [Decision: revise positional inference](../../validation/fruit_point_alignment_prior_2026-09-11/SCIENTIFIC_REPORT.md). Contaminated a2000 amplitude error −19.48% → −0.07%; null/absent-array tests pass. a1100 mismatch errors exceed frozen gate; +19.7% real method cost. 154 new passes retained, 129081 reserved, further revision requires a bounded owner decision |
