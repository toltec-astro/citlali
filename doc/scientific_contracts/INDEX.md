...
and paired bindings. [The admission record](acceptance/SCI_MAP_PROFILE_ADMISSION_2026-09-08/REGISTRATION_AND_SOURCE_BINDING.md)
...
binds independently reviewed candidate `867879b992598484e1bc5b481e5e14ff91c04dab`
and the canonical-first integration. After passing exact merge review and
literal canonical fast-forward, its presence on canonical ancestry admits the
uniform freeze, complete family/profile and independent MAP/JINC successor
bindings. The uniform-first CTI-OD-002 scientific subgate is complete there;
actual implementations and other numerical routes remain gated. The pending
freeze/admission checkpoints below are historical, not a request to repeat
the completed scientific-owner round.

The [2026-09-06 uniform freeze and admission package](acceptance/PTC_UNIFORM_R04_2026-09-06/README.md)
promotes the exact approved r0.4 sources and views after a passing fresh
post-owner consistency review. It supplies the first PTC uniform Registry
entry, complete PTC-owned VAL profile and separate MAP/JINC boundary
successors, preserving all frozen predecessor bytes and literal approved
identifiers. Canonical scientific admission follows exact-candidate and
integration review; application realization and operational availability
remain unassessed. This later record supersedes the pending consistency and
freeze checkpoints below. CTI-OD-003/004/006 remain concrete proposed decisions.

The [2026-09-06 uniform-coefficient scientific approval](studies/CTI_OD_002_COEFFICIENT_AUTHORITY_2026-09-05/stage_b/owner_approval_r04/SCIENTIFIC_OWNER_APPROVAL.md)
adopts exact v0.1-draft.1/r0.4 at `b38ce251207e4f445d5b421f42f774ae3e4f0477`.
All fourteen proposed decisions and the actual-owner question are resolved;
the five deferred subjects remain deferred. Scientific approval is complete.
The next gate is the fresh post-owner consistency review, followed by exact
freeze and separately reviewed Registry/boundary admission. CTI-OD-002 remains
open through those gates; scientific approval does not make a numerical route
available or authorize application implementation. This later acceptance
supersedes the earlier pending coefficient-discussion wording below.
...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.2/SCIENTIFIC_OWNER_FREEZE_R0.4.md) | Approved scope and all nine owner decisions incorporated; predecessor bytes preserved | **Generic scientific authority frozen** at v0.2/r0.4; 52 requirements and 25 predictions; exact profiles and five final generation identities now owner-approved | Canonical registration and source binding follow the [reviewed admission effect](acceptance/SCI_MAP_PROFILE_ADMISSION_2026-09-08/REGISTRATION_AND_SOURCE_BINDING.md); activation remains unavailable and object-specific prerequisites remain | Preserve admitted inactive profiles and frozen science; separately disposition activation or other explicitly scoped contract work; no application or FRUIT transition is implied |
...
| [SCI-VAL — sample/detector validity, flags, and map eligibility](packages/SCI-VAL/v0.1/README.md) | Owner-approved r0.3 Core; all prior Registry/source generations and evaluations preserved | Core remains r0.3 with 49 requirements and 24 predictions; MAP r0.4 exact profile/identity/binding admission has owner approval and post-owner consistency pass | [Canonical incorporation](acceptance/SCI_MAP_PROFILE_ADMISSION_2026-09-08/REGISTRATION_AND_SOURCE_BINDING.md) registers the exact MAP generation and completes formal source binding; activation remains unavailable; four NOI r0.5 successors remain unapproved/unbound | Preserve VAL evaluator ownership and complete inherited records; any activation needs its own explicit owner disposition and cannot supply object facts or numerical parents |
| [SCI-NOI — realization ensembles, empirical uncertainty, and standardized signal](packages/SCI-NOI/v0.1/README.md) | Recovery-first Stage A, owner decisions, implementation-blind Stage B, and bounded r0.5 target-law closure complete | **Scientific authority frozen** at v0.1/r0.5 snapshot commit `2303daf7061a19945a6333099d33dd559cf2abf8`, with approval provenance at branch tip `f28d7a2617160febca85c1c40e6f7ba7494e266e`; freeze-manifest SHA-256 `b6915186424dd52d7c94fb0df47db91654d3c20cf4b3fa6ab98c3554626d8bfc` | Four r0.5 profile successors remain proposed, unapproved, Registry-unbound and unevaluable; uniform authority is admitted and MAP owner policy is incorporated in frozen v0.2/r0.4; MAP activation/object gates, transformed/Wiener/FRUIT authorities and actual numerical-parent gates remain | Preserve frozen r0.5 and the [current MAP admission boundary](acceptance/SCI_MAP_PROFILE_ADMISSION_2026-09-08/REGISTRATION_AND_SOURCE_BINDING.md); later profile admission or scientific correction needs separate authorization; the preserved NOI code candidate remains paused in this task and no implementation qualification is claimed |
