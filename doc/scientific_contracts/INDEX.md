...
| [SCI-PTC — correlated-mode cleaning and detector coefficients](packages/SCI-PTC/v0.1/README.md) | Owner-approved Stage A scope/packet; Q001 diagnostic-only and Q002 frozen-subspace projection resolved `2026-08-19`--`2026-08-20` | Stage B v0.1/r0.3 bounded freeze-candidate revision complete: 89 requirements, 49 predictions, standalone 11-page rationale, complete 20-page engineering view; scientific authority not frozen | Review 12 open/known-but-not-supplied/deferred entries: six owner policy choices, four adjacent-owner inputs, and two deferred evidence choices | Scientific-owner rationale-freeze disposition, then RTC--CAL--PTC coherence profile; defer final cosmetic polish to the final editorial revision; no conformity or validation work yet |
