...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved scientific contract v0.1 scope | Exact three-part packet approved; fresh implementation-blind author dispatched | None at dispatch; unresolved scientific questions remain explicit in the brief | Produce and manager-review the two-view draft; do not rederive MAP-001 or absorb JINC/MAP-003 |
