...
| [SCI-BEAM — Beammap effective PSF, calibration, sensitivity, and APT](packages/SCI-BEAM/v0.1/README.md) | Owner-directed r0.2 scope; absolute boresight/pivot excluded | r0.2 formal contract and separate science-team rationale complete for owner review; 46 requirements and 24 predictions; not frozen | Resolve nine retained sensitivity, adequacy, wing, pivot, accuracy, and kernel questions | Conduct r0.3 owner-voice/presentation pass; change architecture only for a governed inconsistency |
