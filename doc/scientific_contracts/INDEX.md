...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Q02-A/B substance and bounded weighting design approved; exact r0.5 precision diagnostic approved and completed | Q02-C open; no separate MAP-handoff approval or numerical FRUIT family/source adoption. Mapping evidence and execution still gated | [Q02 r0.6 mapping-screen review](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/q02_review/r0.6/README.md): exact U/four-chunk comparator with uniform fallback, synthetic loss tests and exploratory maps on both discovery observations. Method/input/gate/execution decision pending; no maps run or certified policy. 129081 reserved |
