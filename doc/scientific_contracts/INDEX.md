...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A and generic Stage B v0.1/r0.4 remain frozen; ordinary-MAP Q01 scientific definition r0.4 accepted/frozen 2026-09-09 | Q02-A/B substance approved; weighting exploration closed; POINT brief r0.2 accepted; paper reference record r0.1 ready for review | Limited POINT uniform-occurrence/rejoined-MAP substance accepted. Exact source/profile/mode adoption and numerical S/N/control/plan/run bindings pending; no general weighting qualification | [POINT reference record r0.1](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/point_reference/r0.1/README.md): 21 classes, recovered control metadata, B01–B12/S1/profile drafts and explicit rank/support/extent proposals. No numerical execution; frozen science/results preserved; 129081 reserved |
