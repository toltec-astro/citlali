...
| [SCI-FRUIT — iterative feedback, state, and termination](packages/SCI-FRUIT/v0.1/README.md) | Stage A frozen; generic Stage B v0.1/r0.4 conditionally frozen; ordinary-MAP scope D001–D005 approved 2026-09-08 | Concrete paper method/boundary proposal r0.1 complete; historical JINC control and exact MAP r0.7.1 preserved; numerical route unavailable | Review proposed method rules and controlled residual-PTC/rejoined-MAP permissions; coefficient, PTC-plan and numerical support bindings remain missing | Review the [method-definition and boundary proposal](packages/SCI-FRUIT/v0.1/method_preparation/ordinary_map/method_definition/r0.1/README.md); no new scope cycle, author dispatch or experiment approval |
