...
| [SCI-MAP — ordinary mapmaking and observation coaddition](packages/SCI-MAP/v0.1/README.md) | Owner-approved v0.1 scope; bounded freeze-only errata packet rendered `2026-08-28` | Formal, rationale, and ECS synchronized at r0.7.1; byte-identical PTC/MAP boundary, exact manifest-bound atomic and aggregate VAL records, named decision fields, canonical identifiers, exact exposure-product aliases, and externally SHA-bound source manifest; 52 requirement and 25 prediction IDs retained; authority not frozen | Hard numerical gates: exact PTC MAP-facing coefficient family and exact owner-admitted numerical `coverage_cut` state/value. Eight MAP owner decisions remain open; OD-008 is resolved | Scientific-owner content review of r0.7.1; no conformity, validation, achieved response/performance, freeze, readiness, or production claim |
