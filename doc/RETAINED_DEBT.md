...
| D18 | The `SCI-MAP-001` successor keeps ordinary `weight_I` as a nonprecision gridding/normalization coefficient. Marginal precision, covariance, coadd uncertainty, GLS, and statistical-significance interpretations remain unavailable without the applicable `SCI-PTC-001` and noise-package evidence. The complete v1 F010 bundle is unavailable for JINC and detector-grouped products; a signed JINC contribution predicate and corresponding availability remain owned by `SCI-MAP-002`. F009/F010 implementation acceptance remains pending an independent exact-repair-SHA re-audit. F012 is owner-accepted only for the bounded external claims in the 2026-08-05 amendment; its missing operational and internal-reconstruction lanes remain limitations rather than authorization for stronger claims. | Scientific map/product owner with PTC, noise, and JINC owners | An upstream audit approves the required precision/covariance evidence; `SCI-MAP-002` approves a signed method-specific predicate; a versioned consumer requires one of the unavailable products; or the exact repair is ready for independent disposition | A separately approved versioned successor states the applicable estimator, coefficient/covariance meaning, grouping/method availability, products, provenance, and consumer restrictions; affected local and external gates pass; and the responsible audits record their dispositions |
...
- D18 does not authorize GLS, covariance regularization, a precision or
  significance claim, JINC/detector-group algorithm changes, or silent product
  synthesis. Each requires its named owner decision, versioned contract, and
