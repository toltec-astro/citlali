...
def run(command: list[str], *, cwd: Path | None = None) -> str:
    ...
    environment["SOURCE_DATE_EPOCH"] = "1787400000"
...
def verify_sources() -> list[Path]:
    ...
    additional_records = [
        ...
        ROOT / "FORMAL_PARITY_REPORT.md",
        ROOT / "BOUNDARY_IDENTITY_AND_EQUALITY_REPORT.md",
    ]
    ...
    manifested_paths = [
        *(f"src/common/{module}.tex" for module in MODULES),
        ...
        "FORMAL_PARITY_REPORT.md",
        "BOUNDARY_IDENTITY_AND_EQUALITY_REPORT.md",
    ...
    banned_patterns = {
        ...
        "detector indexed by map-pixel p": r"e_\{sp\}|m_\{sp\}|D_\{sp\}",
    }
    ...
    required_semantics = [
        ...
        r"e^{\rm acq}_{sd}",
        r"e^{\rm vo}_{sd}",
        r"SCI-ALIGN_TO_SCI-AST v0.1/r0.1",
    ]
