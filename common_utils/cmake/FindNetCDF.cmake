...
if (NETCDF_DIR)
    message("Looking for NetCDF in ${NETCDF_DIR}")
else()
...
message("Use default paths: ${USE_DEFAULT_PATHS}")

find_path (NETCDF_INCLUDE_DIR NAMES netcdf.h
  HINTS "${NETCDF_DIR}/include" ${USE_DEFAULT_PATHS})
message("Found include: ${NETCDF_INCLUDE_DIR}")
...
find_library (NETCDF_LIBRARY
  ...
  ${USE_DEFAULT_PATHS})
message("Found library: ${NETCDF_LIBRARY}")
...
macro (NetCDF_check_interface lang header libs)
  ...
  message("Looking for ${lang} libs: ${libs}")
  foreach(lib ${libs})
    find_library (NETCDF_${lang}_LIBRARY NAMES ${lib}
...
endmacro ()
list (FIND NetCDF_FIND_COMPONENTS "CXX4" _nextcomp)
...
NetCDF_check_interface (CXX4 netcdf "netcdf-cxx4;netcdf_c++4")
NetCDF_check_interface (CXX netcdfcpp.h netcdf_c++)
NetCDF_check_interface (F77 netcdf.inc  netcdff)
NetCDF_check_interface (F90 netcdf.mod  netcdff)

#export accumulated results to internal varS that rest of project can depend on
list (INSERT NetCDF_libs 0 "${NETCDF_C_LIBRARIES}")
set (NETCDF_LIBRARIES ${NetCDF_libs})
set (NETCDF_INCLUDE_DIRS ${NetCDF_includes})
message("Found NetCDF LIBS: ${NETCDF_LIBRARIES}")
