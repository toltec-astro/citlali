...
Canonical replay note: this source-lane record entered canonical ancestry
through `WP7-REPLAY-001` from exact divergent commit
`49fe73e757daa1885cd23127e8441cba47e648d2`. The validation counts below are
historical source-lane evidence. Canonical replay path disposition and fresh
gates are recorded in
[`WP7_G4_REPLAY_001_D2_TOOLING_2026-08-31.md`](WP7_G4_REPLAY_001_D2_TOOLING_2026-08-31.md).
...
## Source-lane focused validation

At source commit `49fe73e757...`, the four focused modules provided 26
...
The divergent source lane also recorded:
