...
void initialize_raw_timestream_authority(
    ...
    const citlali::config::CalibrationConfig &calibration_request,
...
void initialize_raw_timestream_authority(
    ...
    RtcProc &rtcproc, double native_sample_rate_hz,
    double arcsec_to_rad, double fwhm_to_std) {
    initialize_raw_timestream_authority(
        request, interface_sync_request,
        citlali::config::CalibrationConfig{}, plan, effective_config,
        rtcproc, native_sample_rate_hz, arcsec_to_rad, fwhm_to_std);
}
