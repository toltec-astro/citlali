...
void Engine::get_learning_config(CT &config) {
    ...
    citlali::pipeline::read_optional_learning_config(
    ...
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.diagnostics_enabled, diagnostics);
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.contributor_diagnostics_enabled, diagnostics);
    citlali::pipeline::read_optional_learning_config(
    ...
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.detector_exclusion_enabled, diagnostics);
    citlali::pipeline::read_optional_learning_config(
    ...
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.targeted_contributor_max_pixels, diagnostics, {0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.detector_exclusion_min_pixels, diagnostics, {1});
    citlali::pipeline::read_optional_learning_config(
    ...
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_map_outlier.source_radius_arcsec, diagnostics,
        {0.0});
    citlali::pipeline::read_optional_learning_config(
    ...
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.apply_pre_mapmaking, diagnostics);
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.min_candidate_clusters, diagnostics, {0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.min_candidate_events, diagnostics, {0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.min_max_residual_z, diagnostics,
        {0.0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.severe_candidate_events, diagnostics, {0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.severe_max_residual_z, diagnostics, {0.0});
    citlali::pipeline::read_optional_learning_config(
        ...
        typed_scan_pathology.max_new_flagged_fraction, diagnostics, {0.0});
