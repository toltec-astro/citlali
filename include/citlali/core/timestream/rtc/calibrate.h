...
public:
    ...
    void calibrate_tod(TCData<TCDataKind::RTC, Eigen::MatrixXd> &, Eigen::DenseBase<Derived> &, Eigen::DenseBase<Derived> &, calib_t &);
    void calc_tau();

};

template <typename Derived, class calib_t>
void Calibration::calibrate_tod(TCData<TCDataKind::RTC, Eigen::MatrixXd> &in, Eigen::DenseBase<Derived> &det_indices,
