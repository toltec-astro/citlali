...
TEST(ast_scan_motion,
  ...
  EXPECT_EQ(telescope.tel_data_keys.at("Data.TelescopeBackend.SourceRaAct"),
            "SourceRaAct");
  EXPECT_EQ(telescope.tel_data_keys.at("Data.TelescopeBackend.SourceDecAct"),
            "SourceDecAct");
  EXPECT_EQ(telescope.tel_data_keys.at("Data.TelescopeBackend.TelRaAct"),
            "TelRa");
  EXPECT_EQ(telescope.tel_data_keys.at("Data.TelescopeBackend.TelDecAct"),
            "TelDec");
}
